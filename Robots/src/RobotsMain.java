...
public class RobotsMain
{
    ...
    public RobotsMain() throws AWTException, IOException {
        ...
        Document homepage = Jsoup.connect("http://play.typeracer.com/").get();
        String page = homepage.text();
    ...
    private void type(String s)
    {
        ...
        for (byte b : bytes)
        {
            ...
            if (code > 96 && code < 123) {code = code - 32;}else if(code==58){
